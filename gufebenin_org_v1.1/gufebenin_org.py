...
class Handler(Extract, GetPages):
    base_url = "http://www.gufebenin.org/"
    ...
    def getpages(self, searchquery):
        ...
        companies = self.get_result_list_by_path(
            '//div[@class="entrie-category"]//h3/text()'
        )

        return companies

    def get_initial_page(self, searchquery):
        link = "http://www.gufebenin.org/index.php/entreprises"
        requestOptions = {
            "url": link,
            "method": "GET",
        }
    ...
    def get_overview(self, link):
        ...
        fetchedFields = {
            "vcard:organization-name": "./h3/text()",
