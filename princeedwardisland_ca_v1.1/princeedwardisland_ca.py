...
class Handler(Extract, GetPages):
    ...
    def getpages(self, searchquery):
        ...
        data = {
            ...
            "metaVars": {"save_location": "", "service_id": ""},
        ...
        response = self.get_content(
            url, headers=self.header, method="POST", data=json.dumps(data), timeout=3
        )
        # print(response)
    ...
    def get_address(
        ...
        if addr:
            ...
            temp = {"fullAddress": addr + ", Canada", "country": "Canada"}
    ...
    def get_overview(self, link_name):
        ...
        self.fillField(
            "isIncorporatedIn", key="Registration Date", reformatDate="%d-%b-%Y"
        )
        ...
        self.overview[
            "bst:registryURI"
        ] = f'https://www.princeedwardisland.ca/en/feature/pei-business-corporate-registry-original#/service/LegacyBusiness/LegacyBusinessView;e=LegacyBusinessView;business_number={self.api["Registration Number"]}'
