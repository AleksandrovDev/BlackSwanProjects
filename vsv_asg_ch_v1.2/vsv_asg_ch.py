...
class Handler(Extract, GetPages):
    ...
    def getpages(self, searchquery):
        result = []
        link_1 = "https://www.vsv-asg.ch/de/verband/mitgliederliste"
        self.get_working_tree_api(link_1, "tree")
        links = self.get_by_xpath(
            f'//div[@class="tx-is-vsv-schnittstelle"]//table//tr/td[2]/text()[contains(translate(., "ABCDEFGHIJKLMNOPQRSTUVWXYZ", "abcdefghijklmnopqrstuvwxyz"),"{searchquery.lower()}")]/../../@data-href'
        )
    ...
    def get_overview(self, link_name):
        ...
        try:
            self.fillField("vcard:organization-name", xpath="//div/h1/text()")
        except:
            return None
        ...
        self.fillField(
            "hasActivityStatus",
            xpath='//h2/text()[contains(., "Mitgliedschaft")]/../following-sibling::text()',
        )
        self.overview["regulator_name"] = "Swiss Association of Asset Managers"
        self.overview["regulator_url"] = self.base_url
        self.overview["RegulationStatus"] = "Authorised"
        self.get_address('//div[@class="adresse"]//text()', zipPattern="\d\d\d\d")
